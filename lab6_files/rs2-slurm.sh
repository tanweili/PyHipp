...
#SBATCH -J "rsl2"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rsl2-slurm.%N.%j.out # STDOUT
#SBATCH -e rsl2-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:485232176983:awsnotify --message "RSL2 JOB DONE"
