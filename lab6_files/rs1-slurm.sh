...
#SBATCH -J "rsl1"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rsl1-slurm.%N.%j.out # STDOUT
#SBATCH -e rsl1-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:485232176983:awsnotify --message "RSL1 JOB DONE"
